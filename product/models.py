...
class ProductSKU(BaseModel):
    ...
    type = models.ForeignKey('ProductCategory', on_delete=models.CASCADE, verbose_name="所属分类")
    products = models.ForeignKey('Products', on_delete=models.CASCADE, verbose_name="商品SPU")
...
class ProductBanner(BaseModel):
    ...
    product = models.ForeignKey('ProductSKU', on_delete=models.CASCADE, verbose_name="商品")
...
class PromotionPc(BaseModel):
    ...
    status = models.SmallIntegerField(default=0, choices=ACTIVITY_STATUS, verbose_name="活动状态")
...
class TypeShow(BaseModel):
    ...
    index = models.SmallIntegerField(default=0, verbose_name="展示顺序")
    product = models.ForeignKey('ProductSKU', on_delete=models.CASCADE, verbose_name="商品SKU")
    product_type = models.ForeignKey('ProductCategory', on_delete=models.CASCADE, verbose_name="商品种类")
