...
class OrderInfo(BaseModel):
    ...
    addr = models.ForeignKey('user.UserAddress', on_delete=models.CASCADE, verbose_name='地址')
...
class OrderProduct(BaseModel):
    ...
    product = models.ForeignKey('product.ProductSKU', on_delete=models.CASCADE, verbose_name='商品SKU')
